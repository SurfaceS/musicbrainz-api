...
public class GenreEndpoint extends Endpoint {
	...
	protected static final String GENRE_ENDPOINT = "genre/";

	public GenreEndpoint(MusicBrainzAPIClient musicBrainzAPIClient) {
		super(musicBrainzAPIClient);
	}

	public GenreLookupEndpoint lookupFor(String musicBrainzId) {
		return new GenreLookupEndpoint(musicBrainzAPIClient, musicBrainzId);
	}
