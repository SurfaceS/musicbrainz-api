...
public class EventEndpoint extends Endpoint {
	...
	public EventEndpoint(MusicBrainzAPIClient musicBrainzAPIClient) {
		super(musicBrainzAPIClient);
	}

	public EventLookupEndpoint lookupFor(String musicBrainzId) {
		return new EventLookupEndpoint(musicBrainzAPIClient, musicBrainzId);
	}

	public EventSearchEndpoint search() {
		return new EventSearchEndpoint(musicBrainzAPIClient);
	}
