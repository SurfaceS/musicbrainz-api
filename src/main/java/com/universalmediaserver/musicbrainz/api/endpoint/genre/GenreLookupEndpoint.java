 ...
 * @author SurfaceS
 */
public class GenreLookupEndpoint extends GenreEndpoint {

	private final String musicBrainzId;

	public GenreLookupEndpoint(MusicBrainzAPIClient musicBrainzAPIClient, String musicBrainzId) {
	 ...
	 */
	public GenreSchema getDetails() {
		return musicBrainzAPIClient.get(GENRE_ENDPOINT + musicBrainzId, GenreSchema.class, null);
	}
